...
public class Rutadestinoreport extends VerticalLayout implements View {

	Rutadestinoview objRutadestinoview = new Rutadestinoview();
	
    final Container normalContainer = objRutadestinoview.generateContainer(0,false);
    final Container hierarchicalContainer = objRutadestinoview.generateContainer(0,true);

   /* CheckBox footer = new CheckBox("Footer", true);*/

    public Rutadestinoreport() {
        setMargin(true);
        setSpacing(true);

        Label h1 = new Label("Reporte Ruta-Destinos");
        h1.addStyleName("h1");
        addComponent(h1);

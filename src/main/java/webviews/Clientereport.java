...
public class Clientereport extends VerticalLayout implements View {

	Clienteview objClienteview = new Clienteview();
	
    final Container normalContainer = objClienteview.generateContainer(0,false);
    final Container hierarchicalContainer = objClienteview.generateContainer(0,true);
   ...
   /* CheckBox footer = new CheckBox("Footer", true);*/
    ...
    public Clientereport() {
        ...
        Label h1 = new Label("Reporte de Clientes");
        h1.addStyleName("h1");
        addComponent(h1);

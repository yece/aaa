...
public class Empresareport extends VerticalLayout implements View {

	Cooperativaview objCoopview = new Cooperativaview();
	
    final Container normalContainer = objCoopview.generateContainer(false);
    final Container hierarchicalContainer = objCoopview.generateContainer(true);
   ...
   /* CheckBox footer = new CheckBox("Footer", true);*/
    public Empresareport() {
        ...
        Label h1 = new Label("Empresas de Transporte");
        h1.addStyleName("h1");
        addComponent(h1);
